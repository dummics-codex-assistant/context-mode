...
<context_window_protection>
  ...
  <tool_selection_hierarchy>
    ...
    1. GATHER: ${t("ctx_batch_execute")}(commands, queries)
      ...
      - label becomes FTS5 chunk title / titoli FTS5 — descriptive labels / label descrittive improve search.
